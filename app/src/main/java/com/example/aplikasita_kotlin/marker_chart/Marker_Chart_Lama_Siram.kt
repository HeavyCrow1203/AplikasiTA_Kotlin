...
class Marker_Chart_Lama_Siram (context: Context, layoutResource: Int, xLabel: ArrayList<String>) :
    MarkerView(context, layoutResource) {
    private var tanggal_value: TextView
    private var waktu_value: TextView
    private var lama_siram: TextView
    ...
    override fun refreshContent(e: Entry?, highlight: Highlight?) {
        ...
        val nilai_lama_siram = e?.y.toString()
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    if (snapshot.hasChildren()) {
                        ...
                        for (snapshot1 in snapshot.children) {
                            ...
                            lama_siram.text = "Durasi Siram : $nilai_lama_siram s"
