...
class Marker_Chart_Kelembaban (context: Context, layoutResource: Int, xLabel: ArrayList<String>) :
    MarkerView(context, layoutResource) {
    private var tanggal_value: TextView
    private var waktu_value: TextView
    private var kelembaban: TextView
    ...
    override fun refreshContent(e: Entry?, highlight: Highlight?) {
        ...
        val nilai_kelembaban_tanah = e?.y.toString()
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    if (snapshot.hasChildren()) {
                        ...
                        for (snapshot1 in snapshot.children) {
                            ...
                            kelembaban.text = "Kelembaban Tanah : $nilai_kelembaban_tanah %"
